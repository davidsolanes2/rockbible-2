...
public class SexResourceIntTest {
    ...
    private static final String DEFAULT_SEX_NAME = "AAAAAAAAAA";
    private static final String UPDATED_SEX_NAME = "BBBBBBBBBB";
    ...
    public void createSex() throws Exception {
        ...
        assertThat(testSex.getSexName()).isEqualTo(DEFAULT_SEX_NAME);
    }
    ...
    public void getAllSexes() throws Exception {
        ...
        restSexMockMvc.perform(get("/api/sexes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sexName").value(hasItem(DEFAULT_SEX_NAME.toString())));
    }
    ...
    public void getSex() throws Exception {
        ...
        restSexMockMvc.perform(get("/api/sexes/{id}", sex.getId()))
            ...
            .andExpect(jsonPath("$.sexName").value(DEFAULT_SEX_NAME.toString()));
    }
    ...
    public void updateSex() throws Exception {
        ...
        Sex testSex = sexList.get(sexList.size() - 1);
        assertThat(testSex.getSexName()).isEqualTo(UPDATED_SEX_NAME);
    }
