...
public class LabelResourceIntTest {
    ...
    private static final String DEFAULT_NAME_LABEL = "AAAAAAAAAA";
    private static final String UPDATED_NAME_LABEL = "BBBBBBBBBB";
    ...
    public void createLabel() throws Exception {
        ...
        assertThat(testLabel.getNameLabel()).isEqualTo(DEFAULT_NAME_LABEL);
    }
    ...
    public void getAllLabels() throws Exception {
        ...
        restLabelMockMvc.perform(get("/api/labels?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nameLabel").value(hasItem(DEFAULT_NAME_LABEL.toString())));
    }
    ...
    public void getLabel() throws Exception {
        ...
        restLabelMockMvc.perform(get("/api/labels/{id}", label.getId()))
            ...
            .andExpect(jsonPath("$.nameLabel").value(DEFAULT_NAME_LABEL.toString()));
    }
    ...
    public void updateLabel() throws Exception {
        ...
        Label testLabel = labelList.get(labelList.size() - 1);
        assertThat(testLabel.getNameLabel()).isEqualTo(UPDATED_NAME_LABEL);
    }
