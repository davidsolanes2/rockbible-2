...
public class SocialResourceIntTest {
    ...
    private static final String DEFAULT_NAME_SOCIAL = "AAAAAAAAAA";
    private static final String UPDATED_NAME_SOCIAL = "BBBBBBBBBB";
    ...
    public static Social createEntity(EntityManager em) {
        Social social = new Social()
            .nameSocial(DEFAULT_NAME_SOCIAL);
        return social;
    }
    ...
    public void createSocial() throws Exception {
        ...
        assertThat(testSocial.getNameSocial()).isEqualTo(DEFAULT_NAME_SOCIAL);
    }
    ...
    public void getAllSocials() throws Exception {
        ...
        restSocialMockMvc.perform(get("/api/socials?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nameSocial").value(hasItem(DEFAULT_NAME_SOCIAL.toString())));
    }
    ...
    public void getSocial() throws Exception {
        ...
        restSocialMockMvc.perform(get("/api/socials/{id}", social.getId()))
            ...
            .andExpect(jsonPath("$.nameSocial").value(DEFAULT_NAME_SOCIAL.toString()));
    }
    ...
    public void updateSocial() throws Exception {
        ...
        updatedSocial
            .nameSocial(UPDATED_NAME_SOCIAL);
        ...
        Social testSocial = socialList.get(socialList.size() - 1);
        assertThat(testSocial.getNameSocial()).isEqualTo(UPDATED_NAME_SOCIAL);
    }
