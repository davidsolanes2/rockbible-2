...
public class CollectionResourceIntTest {
    ...
    private static final String DEFAULT_NAME_COLLECTION = "AAAAAAAAAA";
    private static final String UPDATED_NAME_COLLECTION = "BBBBBBBBBB";
    ...
    public static Collection createEntity(EntityManager em) {
        Collection collection = new Collection()
            .nameCollection(DEFAULT_NAME_COLLECTION);
        return collection;
    }
    ...
    public void createCollection() throws Exception {
        ...
        assertThat(testCollection.getNameCollection()).isEqualTo(DEFAULT_NAME_COLLECTION);
    }
    ...
    public void getAllCollections() throws Exception {
        ...
        restCollectionMockMvc.perform(get("/api/collections?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nameCollection").value(hasItem(DEFAULT_NAME_COLLECTION.toString())));
    }
    ...
    public void getCollection() throws Exception {
        ...
        restCollectionMockMvc.perform(get("/api/collections/{id}", collection.getId()))
            ...
            .andExpect(jsonPath("$.nameCollection").value(DEFAULT_NAME_COLLECTION.toString()));
    }
    ...
    public void updateCollection() throws Exception {
        ...
        updatedCollection
            .nameCollection(UPDATED_NAME_COLLECTION);
        ...
        Collection testCollection = collectionList.get(collectionList.size() - 1);
        assertThat(testCollection.getNameCollection()).isEqualTo(UPDATED_NAME_COLLECTION);
    }
